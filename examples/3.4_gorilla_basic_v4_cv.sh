...
python3 -m verl.trainer.main \
    trainer.experiment_name=3.4_gorilla_basic_v4_cv \
    config=examples/config.yaml \
    data.train_files=maxvonk/gorilla-pairs-v4-800px-cv@train \
    data.val_files=maxvonk/gorilla-pairs-v4-800px-cv@test \
