...
python3 -m verl.trainer.main \
    trainer.experiment_name=3.4_gorilla_basic_v3_30k_6g \
    config=examples/config.yaml \
    data.train_files=maxvonk/gorilla-pairs-v3-30k-800px@train \
    data.val_files=maxvonk/gorilla-pairs-v3-30k-800px@validation \
