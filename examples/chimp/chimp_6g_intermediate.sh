...
python3 -m verl.trainer.main \
    trainer.experiment_name=3.4_chimp_6g_intermediate_new_test_g_ \
    config=examples/config.yaml \
    data.train_files=maxvonk/chimp-pairs-v2-800px-meta-data-fixed-names-im@train \
    data.val_files=maxvonk/chimp-pairs-v2-800px-meta-data-fixed-names-im@test \
