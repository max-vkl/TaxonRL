...
python3 -m verl.trainer.main \
    trainer.experiment_name=4.2_bird_paper_im_concrete_6g_60p \
    ...
    worker.reward.reward_function=/workspaces/EasyR1/examples/reward_function/lfw_bird_im_concrete_60p.py:compute_score_gemini \
