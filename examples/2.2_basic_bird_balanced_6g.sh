...
python3 -m verl.trainer.main \
    trainer.experiment_name=2.2_basic_bird_balanced \
    config=examples/config.yaml \
    data.train_files=maxvonk/bird-pairs-v2-balanced-800px@train \
    data.val_files=maxvonk/bird-pairs-v2-balanced-800px@validation \
