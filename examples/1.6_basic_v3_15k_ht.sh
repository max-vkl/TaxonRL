...
python3 -m verl.trainer.main \
    trainer.experiment_name=1.6_basic_v3_15k_high_temperature \
    config=examples/config.yaml \
    data.train_files=maxvonk/gorilla-pairs-v3-15k-800px@train \
    data.val_files=maxvonk/gorilla-pairs-v3-15k-800px@validation \
