...
python3 -m verl.trainer.main \
    trainer.experiment_name=3.3_chimp_clean_6g_same_test \
    config=examples/config.yaml \
    data.train_files=maxvonk/chimp-pairs-v2-800px-meta-data-fixed-names-same-test@train \
    data.val_files=maxvonk/chimp-pairs-v2-800px-meta-data-fixed-names-same-test@test \
